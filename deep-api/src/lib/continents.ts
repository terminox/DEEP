...
//
// The 249 officially assigned alpha-2 codes, plus `XK` — Kosovo is only
// user-assigned in ISO-3166, but MaxMind emits it, and this table exists to
// speak MaxMind's alphabet.
